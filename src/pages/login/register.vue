<template>
	<div class="register-vue" :style="bg">
		<div class="container">
			...
			<div class="input-c">
				<Input v-model="pwd" type="password" prefix="md-lock" placeholder="密码" clearable @on-blur="verifyPwd" @keyup.enter="submit" />
...
export default {
	...
	created() {
		...
		this.bg.backgroundImage = 'url(' + 'https://cn.bing.com/th?id=OHR.OceanHeart_ZH-CN2697021215_UHD.jpg' + ')';
	},
	methods: {
		verifyAccount() {
